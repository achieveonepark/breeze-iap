...
const repositoryUrl = 'https://github.com/achieveonepark/breeze-iap';

const config: Config = {
  title: 'Breeze IAP',
  tagline: 'Breeze IAP documentation',
  favicon: 'favicon.svg',
  ...
  themeConfig: {
    ...
    footer: {
      style: 'dark',
      links: [],
      copyright: 'MIT License · Copyright © Breeze IAP',
    },
    prism: {
